...
private:
	...
	int Explosion_[6] = {
	    Novice::LoadTexture("./Resource./Explosion1.png"),
	    Novice::LoadTexture("./Resource./Explosion2.png"),
	    Novice::LoadTexture("./Resource./Explosion3.png"),
	    Novice::LoadTexture("./Resource./Explosion4.png"),
	    Novice::LoadTexture("./Resource./Explosion5.png"),
	    Novice::LoadTexture("./Resource./Explosion6.png")};
};